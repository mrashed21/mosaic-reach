        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="professional-card">
              ...
              <CardContent>
                <CardDescription>
                  Ultra-fast performance and lightning-quick response times for
            ...
            <Card className="professional-card">
              ...
              <CardContent>
                <CardDescription>
                  Bank-level security with 99.9% uptime guarantee. Your data is
                  always protected.
                </CardDescription>
              </CardContent>
            </Card>
            <Card className="professional-card">
              ...
              <CardContent>
                <CardDescription>
                  Scalable solutions that grow with your business across
                  multiple continents.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            {[
              {
                ...
                desc: "Modernize your business with cutting-edge digital solutions.",
              },
              {
                title: "Cloud Solutions",
                desc: "Scalable cloud infrastructure for enterprise-grade applications.",
              },
              {
                title: "Consulting Services",
                desc: "Expert guidance for strategic business and technology decisions.",
              },
              {
                title: "Custom Development",
                desc: "Bespoke software solutions tailored to your unique needs.",
              },
              {
              ...
              },
              {
                ...
                desc: "24/7 technical support and proactive system maintenance.",
              },
            ].map((service, index) => (
            ...
            {[
              {
                ...
                content:
                  "GlobalCorp transformed our business operations completely. Their expertise and dedication are unmatched.",
                rating: 5,
              },
              {
                ...
                content:
                  "Exceptional service quality and professional approach. They delivered exactly what they promised.",
                rating: 5,
              },
              {
                name: "Maria Santos",
                ...
                content:
                  "The team's technical expertise and customer service exceeded our expectations in every way.",
                rating: 5,
              },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                excerpt:
                  "Key insights into market dynamics and opportunities for growth...",
                date: "March 12, 2024",
                category: "Business",
              },
              {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              Get in touch with our experts and discover how we can help you
              achieve your goals.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
