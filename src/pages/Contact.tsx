...
export const Contact: React.FC = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      message:
        "The best customer service experience we've had with any vendor.",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="min-h-screen">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-professional mb-2">
                            {method.description}
                          </p>
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="heading-lg text-foreground mb-4">{t("location")}</h2>
            <p className="text-xl text-professional max-w-2xl mx-auto">
              Visit us at any of our global offices or connect with us remotely
            ...
            <div className="professional-card p-8 bg-gradient-secondary text-center rounded-lg h-80 flex items-center justify-center">
              <div>
                ...
                <p className="text-professional">
                  Our global offices are strategically located to serve clients
                  worldwide
                </p>
              </div>
            </div>
      ...
      <section className="section-padding bg-secondary/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-professional max-w-2xl mx-auto">
              Connect with us directly through phone or email for immediate
              assistance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="professional-card text-center">
              <CardContent className="p-8">
                ...
                <Button className="btn-hero">Call Now</Button>
              </CardContent>
            </Card>
            ...
            <Card className="professional-card text-center">
              <CardContent className="p-8">
                ...
                <Button className="btn-hero">Send Email</Button>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="professional-card text-center group hover:bg-blue-50 dark:hover:bg-blue-950 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-professional text-sm mb-4">
                  Follow for company updates
                </p>
      ...
      <section className="section-padding bg-gradient-secondary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-professional max-w-2xl mx-auto">
              We're here when you need us. Check our availability across
          ...
          <div className="mt-12 text-center professional-card p-6 bg-primary/5 border border-primary/20">
            ...
            <p className="text-professional mb-4">
              For critical issues outside business hours, our emergency support
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-professional max-w-2xl mx-auto">
              Get the right type of support for your specific needs with our
              specialized teams.
            </p>
          </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-professional">
                        Response time: {support.response}
                      </span>
                    </div>
                  </div>
      ...
      <section className="section-padding bg-secondary/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="heading-lg text-foreground mb-4">{t("feedback")}</h2>
            <p className="text-xl text-professional max-w-2xl mx-auto">
          ...
          <Card className="professional-card max-w-2xl mx-auto">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full btn-hero">Submit Feedback</Button>
            </CardContent>
          </Card>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              ...
              innovative solutions. Our team is ready to bring your vision to
              life.
            </p>
